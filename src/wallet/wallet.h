...
/*
 * lebowskiscoin: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * lebowskiscoin: Creating change outputs at exactly the dustlimit is counter-
...
public:
    ...
    /**
     * FirebugCoin: Get a fee targetting a specific transaction speed.
     */
    ...
    /**
     * Return the minimum required fee taking into account the
     * floating relay fee and user set minimum transaction fee, but not the Firebug Coin dust fee.
     */
