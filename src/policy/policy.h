...
/** Recommended transaction fee by Firebug Coin Core developers
  *
 ...
 *
 *  lebowskiscoin:    Increment mempool limits and accept RBF in steps of 0.0001 DOGE
...
/**
 * lebowskiscoin: Default dust limit that is evaluated when considering whether a
...
/**
 * lebowskiscoin: Default hard dust limit that is evaluated when considering whether
