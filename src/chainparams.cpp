...
// Copyright (c) 2022 The Firebug Coin Core developers
...
{
    const char* pszTimestamp = "pyrrhocoris apterus is the best bug";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x1f4ccde8d654efb4449ca6ce69b866b177d58ccdd91b044bdd27a74f16ec817a");
         ...
         */
        pchMessageStart[0] = 0xda; //set this
        ...
        genesis = CreateGenesisBlock(1773257888, 1369296945, 0x1e0ffff0, 1, 20 * COIN); // 12097647
        ...
        std::cout << "Genesis block merkle root: " << genesis.hashMerkleRoot.ToString() << std::endl;

        assert(consensus.hashGenesisBlock == uint256S("0x1f4ccde8d654efb4449ca6ce69b866b177d58ccdd91b044bdd27a74f16ec817a"));
        assert(genesis.hashMerkleRoot == uint256S("0x06b413df8c12f0943706e6bc96de2f9032c63a2e950dca506464f53de942b38b"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("novixx.com", "seed.novixx.com"));
        ...
        checkpointData = (CCheckpointData) {
                boost::assign::map_list_of
                        (      0, uint256S("0x1f4ccde8d654efb4449ca6ce69b866b177d58ccdd91b044bdd27a74f16ec817a"))
        };
