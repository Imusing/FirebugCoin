...
void Shutdown()
{
    ...
    RenameThread("lebowskiscoin-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Firebug Coin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/lebowskiscoin-community/lebowskiscoin>";
    const std::string URL_WEBSITE = "<https://github.com/lebowskiscoin-community/lebowskiscoin>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("lebowskiscoin-loadblk");
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("FirebugCoin version %s\n", FormatFullVersion());
}
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // lebowskiscoin: Do we need to do any RPC mining init here?
