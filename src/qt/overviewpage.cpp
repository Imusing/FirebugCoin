...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the FirebugCoin Core repository on GitHub"),
        tr("Services that claim to double your lebowskiscoin are always ponzi schemes")
    };
