...
// Copyright (c) 2020 The Firebug Coin Core developers
...
void PaymentServerTests::paymentServerTests()
{
    ...
    // lebowskiscoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Firebug Coin (as there is no actual maximum coins)
