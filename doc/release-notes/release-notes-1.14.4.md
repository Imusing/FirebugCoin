Firebug Coin Core version 1.14.4 is now available from:

  <https://github.com/lebowskiscoin/lebowskiscoin/releases/tag/v1.14.4/>
...
operators to agree on fees regardless of defaults coded into the Firebug Coin Core
...
* The default setting shipped with lebowskiscoin core for relay fee has been reduced
