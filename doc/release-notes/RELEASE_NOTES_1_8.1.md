# Firebug Coin Core 1.8.1

Firebug Coin Core 1.8.1 is primarily a bugfix release, bringing Firebug Coin Core in
line with Bitcoin 0.9.3. Firebug Coin Core 1.8.1 also adds in support for printing
...
## Firebug Coin Core Release Notes

* Translation improvements and corrections
* Disable Transifex based translation process (not used by Firebug Coin Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 Firebug Coin Core clients
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/lebowskiscoin/lebowskiscoin/issues/134).
