Firebug Coin Core version 1.14.2 is now available from:

  <https://github.com/lebowskiscoin/lebowskiscoin/releases/tag/v1.14.2/>
...
To receive security and update notifications, please watch reddit or Twitter:
  ...
  * https://www.reddit.com/r/lebowskiscoin/
...
Firebug Coin Core is extensively tested on Ubuntu Server LTS, Mac OS X and Windows 10.
...
Firebug Coin Core introduces pruning the blockchain in 1.14. Pruning
...
When Firebug Coin Core is out-of-sync on startup, a semi-transparent information
...
Since 1.14.0 the approximate transaction fee shown in Firebug Coin-Qt when using coin
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Firebug Coin Core. This was added in conjunction with
