FirebugCoin Core version 1.14.6 is now available from:

  <https://github.com/lebowskiscoin/lebowskiscoin/releases/tag/v1.14.6/>

This is a new minor version release, including important security updates and
changes to network efficiency. All Firebug Coin Core users - miners, services,
...
To receive notifications about updates, subscribe to the release mailing list:
  ...
  <https://sourceforge.net/projects/lebowskiscoin/lists/lebowskiscoin-releases>
...
Firebug Coin network from 1 DOGE to 0.01 DOGE. The full recommendation can be found
...
```
apterus-cli addnode <address> remove
```
...
```
apterus-cli liststucktransactions
```
...
```
apterus-cli setmaxconnections <desired_amount>
```
...
```
apterus-cli rescan <start_block>
```
...
efforts to make Firebug Coin more accessible to people that do not speak English.
...
* Improved and updated the [bip list](bips.md) documentation that explains the
  protocol features implemented by Firebug Coin Core.
