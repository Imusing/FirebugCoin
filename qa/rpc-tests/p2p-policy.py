#!/usr/bin/env python3
# Copyright (c) 2021-2022 The FirebugCoin Core developers
...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # a FirebugCoin Core node that behaves similar to mainnet policies
    ...
    def run_test(self):
        ...
        # create a bunch of UTXO with seed money from the Firebug Coin Core wallet
        for i in range(20):
    ...
    # spend seed money with a key not in the Firebug Coin Core wallet.
    def spend_utxo(self, output, expected_size, retries=0):
        # construct the transaction using Firebug Coin Core raw tx APIs
        ...
        # and send the tx from there rather than from Firebug Coin Core, to test
