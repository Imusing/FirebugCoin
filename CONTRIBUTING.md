# Contributing to FirebugCoin Core

FirebugCoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/lebowskiscoin/lebowskiscoin/labels/help%20wanted)
* [Projects](https://github.com/lebowskiscoin/lebowskiscoin/projects)
* [apterusdev on reddit](https://www.reddit.com/r/apterusdev/)

## Branch Strategy

FirebugCoin Core's default branch is intentionally a stable release, so that anyone
...
FirebugCoin Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Firebug Coin Core
releases will automatically benefit from these.

When refactoring Firebug Coin-specific code, please keep refactoring requests short,
low complexity and easy to verify.


## "Decision Making" Process

The following applies to code changes to Firebug Coin Core, and is not to be
confused with overall Firebug Coin Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Firebug Coin Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Firebug Coin; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Firebug Coin
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Firebug Coin consensus, it must have been
